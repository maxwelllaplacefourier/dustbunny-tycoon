...
if ~ishandle(guiel.CursorWindow)
    CursorWindow = uipanel(guiel.APPWINDOW,'Units','pixels','Position',[cnst.cpwidth+cnst.displaywidth-250 cnst.displayheight/2-100 cnst.bwidth 4*cnst.bheight],...
    ...
    cursorTxt = uicontrol('Parent',CursorWindow,'Style','text','Units','Normalized','FontSize',6,...
                ...
                'String',strvcat(['Time: ' num2str(currTime(mouseIndex))],[response_type ': ' num2str(currPos(mouseIndex))],['Input: ' num2str(input.signals.values(mouseIndex))]),'UserData',copyString,...
    ...
    uicontrol('Parent',CursorWindow,'Units','pixels','Style','Pushbutton','String','Copy Point',...
                'Position',[20 2 cnst.bwidth-40 20],...
                'UserData',cursorTxt,...
