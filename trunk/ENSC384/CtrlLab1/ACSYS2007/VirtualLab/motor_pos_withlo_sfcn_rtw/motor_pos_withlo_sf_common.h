...
#ifndef _RTW_COMMON_HEADER_FILE_motor_pos_withlo_sf_
#define _RTW_COMMON_HEADER_FILE_motor_pos_withlo_sf_

#define S_FUNCTION_NAME                 motor_pos_withlo_sf
...
typedef struct motor_pos_withlo_BlockIO_tag {
...
typedef struct motor_pos_withlo_Parameters_tag {
  real_T Integrator_IC;                 /* Expression: 0
                                         * External Mode Tunable: no
                                         * Referenced by block:
                                         * <S1>/Integrator
                                         */
} motor_pos_withlo_Parameters;
...
typedef struct motor_pos_withlo_ContinuousStates_tag {
  real_T Integrator_CSTATE;
  real_T Electrical_CSTATE;
  real_T Mechanical_CSTATE;
} motor_pos_withlo_ContinuousStates;
 ...
 *
 */
typedef struct motor_pos_withlo_StateDerivatives_tag {
  real_T Integrator_CSTATE;
  real_T Electrical_CSTATE;
  real_T Mechanical_CSTATE;
} motor_pos_withlo_StateDerivatives;
...
typedef struct motor_pos_withlo_ExternalUPtrs_tag {
  real_T *E_in;
} motor_pos_withlo_ExternalUPtrs;
...
typedef struct motor_pos_withlo_ExternalOutputs_tag {
  real_T *Position_out;
} motor_pos_withlo_ExternalOutputs;

/* non-finites */
extern real_T rtMinusInf;

#endif                                  /* _RTW_COMMON_HEADER_FILE_motor_pos_withlo_sf_ */

/* [EOF] motor_pos_withlo_sf_common.h */
