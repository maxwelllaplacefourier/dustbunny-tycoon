% getlsim() - A MATLAB based application used to input system state space model.
...
LSIMWIND=figure('Units','Normal','Position',[0.15 0.35 .35 .35],...
...
h0(1)=uicontrol(LSIMWIND,'Style','Text','Units','Normal', ...
...
guiele.h(1,2)=uicontrol(LSIMWIND,'Style','Edit','Units','Normal', ...
	'Foreground',BLACK,'Background',TEDITBAK,...
	'Position',[2.0*BOX1_W  16.5*BOX1_H 5.50*BOX1_W 1.5*BOX1_H], ...
	'String',num2str(t0),'Fontsize',10,'FontWeight','Demi','keypressfcn','eval(cnstn.StateOtherInputsEnterPress);');

guiele.h(2,2)=uicontrol(LSIMWIND,'Style','Edit','Units','Normal', ...
	'Foreground',BLACK,'Background',TEDITBAK,...
	'Position',[2.0*BOX1_W  13*BOX1_H 5.50*BOX1_W 1.5*BOX1_H], ...
	'String',num2str(tstep),'Fontsize',10,'FontWeight','Demi','keypressfcn','eval(cnstn.StateOtherInputsEnterPress);');

guiele.h(3,2)=uicontrol(LSIMWIND,'Style','Edit','Units','Normal', ...
	'Foreground',BLACK,'Background',TEDITBAK,...
	'Position',[2.0*BOX1_W  9.5*BOX1_H 5.50*BOX1_W 1.5*BOX1_H], ...
	'String',num2str(tsim),'Fontsize',10,'FontWeight','Demi','keypressfcn','eval(cnstn.StateOtherInputsEnterPress);');

guiele.h(4,2)=uicontrol(LSIMWIND,'Style','Edit','Units','Normal', ...
	'Foreground',BLACK,'Background',TEDITBAK,...
	'Position',[2.0*BOX1_W  5.5*BOX1_H 5.50*BOX1_W 1.5*BOX1_H], ...
	'String',num2str(input),'Fontsize',10,'FontWeight','Demi','keypressfcn','eval(cnstn.StateOtherInputsEnterPress);');

cnstn.StateOtherInputsEnterPress=[... %this is the keypressfcn for the four edit boxes created above.
                            'if double(get(LSIMWIND,''currentcharacter'')) == 13;',...
                            '  eval(get(h_plot,''callback''));',...
                            'end;',...
                            ];

% ====================plot button========================================
h_plot=uicontrol(LSIMWIND,'Style','PushButton','Units','Normal',...
   'Position',[3.50*BOX1_W  2.5*BOX1_H 3.00*BOX1_W 2*BOX1_H],...
   'String',' PLOT ','Fontsize',10,'FontWeight','Bold',...
	'CallBack',[...
       'set(LSIMWIND,''pointer'',''watch'');',...
       'drawnow;',...
       ...
       'lsim(Statemodel,vabls.numinput,vabls.tset),xlabel(''Time (sec)''),ylabel(''Amplitude''),title(''Time Response''),',...
       'set(LSIMWIND,''pointer'',''arrow'');',...
       'close(LSIMWIND);',...
    ]);
%============================================== DONE PushButton
h_DONE=uicontrol(LSIMWIND,'Style','PushButton','Units','Normal',...
