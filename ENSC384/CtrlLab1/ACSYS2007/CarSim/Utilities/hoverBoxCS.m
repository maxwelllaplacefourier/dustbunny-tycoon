...
function hoverBoxCS(figg,hPanel,topbar);
...
set(figg,'WindowButtonMotionFcn',...
    ...
    'if (vars.currpos(1)+vars.currpos(3)-50 < 0) vars.currpos(1)= -vars.currpos(3)+50; end;'...
    'if (vars.currpos(2)+vars.currpos(4)-20 < 0) vars.currpos(2)= -vars.currpos(4)+20; end;'...
