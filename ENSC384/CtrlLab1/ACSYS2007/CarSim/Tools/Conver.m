% UPDATED August 2003 By Brad Schubert
% Changes: 
% - copywrite date changed to 1997-2003
% - windowstyle = normal instead of modal
% - clears the variables it creates from the workspace (except for
% LIGHTGREY and TITLFORE because the rest of Acsys needs them)

VarString = ['clear(''cMARGIN'', ',...
             '''cBOX1_W'', ',...
             '''cBOX1_H'', ',...
             '''matrix'', ',...
             '''dimen'', ',...
...
CONVWIND=figure('Units','Normal','Position',[0.3 0.3 .4 .3],...
	'color',LIGHTGREY,'Name','Unit Conversion Tool ©1997-2003 Farid Golnaraghi',...
    'closerequestfcn', 'VarString = evalin(''base'', ''VarString''); eval(VarString), closereq',...
	'NumberTitle','off','WindowStyle','normal','Resize','Off');
...
convert = uicontrol(CONVWIND,...
 ...
 uicontrol(CONVWIND,...
		...
		'CallBack','close(gcf), if exist(''VarString''), eval(VarString), end');
