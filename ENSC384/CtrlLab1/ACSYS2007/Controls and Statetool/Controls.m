...
%displays the closed loop transfer function and the poles and zeros.
  cnstn.EnterButtonCallback=[...
      ...
      'if vabls.ExtentTF(3) > 1 ; eval(cnstn.BigTF); end;',...
...
cnstn.DisplayG=['text(''position'',[0.3*BOX1_W*1.890 19.3*BOX1_H],''unit'',''normal'',',...
      ...
      'text(''position'',[.059 14*BOX1_H],''Units'',''Normalized'',',...
      ' ''Color'',BLACK,''FontWeight'',''Demi'',''Interpreter'',''latex'',''FontSize'',11,',...
      ' ''String'',[''\underline{\textbf{TF Zeros are:}} '']);',...
      'if dzeroTF<10,',...
      ' for ii=1:dzeroTF,',...
      '     if isempty(zeroTF)~=1,',...
      '         text(''position'',[.078 (14-ii)*BOX1_H],''Units'',''Normalized'',',...
      ...
      '         ''String'','' '');',...
	  ' end,end,end,',...
      'guiele.PoleText=text(''position'',[.55 14*BOX1_H],''unit'',''normal'',',...
      ' ''Color'',BLACK,''FontWeight'',''Demi'',''Interpreter'',''latex'',''FontSize'',11,',...
      ' ''String'',[''\underline{\textbf{TF Poles are:}} '']);',...
      'if dpoleTF<10,',...
      ' for jj=1:dpoleTF,',...
      '     if isempty(poleTF)~=1,',...
      '         text(''position'',[.57 (14-jj)*BOX1_H],''Units'',''Normalized'',',...
      '         ''Color'',BLACK,''FontWeight'',''Demi'',''Interpreter'',''latex'',''FontSize'',11,',...
  ...
  %==========Error Messages
    ...
    cnstn.BigTF=[...
                'delete(guiele.TextTF);',...
                'guiele.WarnWind=warndlg(cnstn.WindowExeeded);',...
                'set(guiele.WarnWind,''windowstyle'',''modal'');',...
                ];
                
                
    cnstn.WindowExeeded={'Warning: Window size exceeded.';'Press the "Display on Command Line"';'button to see results.'};
