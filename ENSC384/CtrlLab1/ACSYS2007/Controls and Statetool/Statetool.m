...
guiele.SWIND=figure(999);
                    
set(guiele.SWIND,'Units','pixels','Position',[20 80 276 600],...
	'Name','State Space Tool','dockcontrols','off','resize','off',...
...
guiele.StateSpaceCalc=uimenu(guiele.CalculateDisplay,'label','State Space Calculations',...
	'CallBack',[,...
        ...
        'set(cnstn.DisabledControls,''enable'',''On''),',...    %This needs to be last so it doesn't do it when bad values have been entered.
    ]);
...
cnstn.DisabledControls=[guiele.Observability,guiele.Controlability,guiele.StateTimeResponseMenu,guiele.StateStepResponse,guiele.StateImpulseResponse,guiele.StateNaturalResponse,guiele.StateOtherInputs]; %These are controls that can only be used after the State Space calculations have been run.
...
guiele.TextBoxA=uicontrol(guiele.StateInputPanel,'tag','guiele.TextBoxA','style','edit','units','pixels',...   
    ...
    'callback','Amat=str2num(get(guiele.TextBoxA,''string'')); set(cnstn.DisabledControls,''enable'',''off''),');
...
guiele.TextBoxB=uicontrol(guiele.StateInputPanel,'tag','guiele.TextBoxB','style','edit','units','pixels',...   
    ...
    'callback','Bmat=str2num(get(guiele.TextBoxB,''string'')); set(cnstn.DisabledControls,''enable'',''off''),');
...
guiele.TextBoxC=uicontrol(guiele.StateInputPanel,'tag','guiele.TextBoxC','style','edit','units','pixels',...   
    ...
    'callback','Cmat=str2num(get(guiele.TextBoxC,''string'')); set(cnstn.DisabledControls,''enable'',''off''),');
...
guiele.TextBoxD=uicontrol(guiele.StateInputPanel,'tag','guiele.TextBoxD','style','edit','units','pixels',...   
    ...
    'callback','Dmat=str2num(get(guiele.TextBoxD,''string'')); set(cnstn.DisabledControls,''enable'',''off''),');
...
guiele.TextBoxIC=uicontrol(guiele.StateInputPanel,'tag','guiele.TextBoxA','style','edit','units','pixels',....
    ...
    'callback','ICmat=str2num(get(guiele.TextBoxIC,''string'')); set(cnstn.DisabledControls,''enable'',''off''),');
