...
% of Matlab R12. 
% To run, select Experiment #3 from the Experiment Menu in SIMLab
%
...
% SIMLab, Experiment 3: Open Loop Speed GUI
% Last Modified: July 10, 2007
%=============================================================

vars.response_type = 'Speed';
vars.simfilename = 'openloopstep_sim';

vars.simtime = 3;
    set(guiel.APPWINDOW,'Name','SIMLab: Experiment 3: Open Loop Speed © 2007 Farid Golnaraghi');

    exp_fig;
    
    guiel.helptext = {...
        'SIMLab - Experiment 3: Open Loop Speed',...
        '',...
