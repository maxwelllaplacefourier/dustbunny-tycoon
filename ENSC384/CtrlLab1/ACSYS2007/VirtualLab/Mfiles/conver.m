...
CONVWIND=figure('Units','Normal','Position',[0.3 0.3 .4 .3],...
	'color',TITLEBAK,'Name','Unit Conversion Tool ©1997 MSI',...
	'NumberTitle','off','WindowStyle','Modal','Resize','Off');
      
uicontrol(CONVWIND,'Units','Normal','Style','Text',...
   'Position',[ 1/10  5/9 1.5/10 1/9],'Foreground',TITLEFOR,'Background',TITLEBAK,...
   'Horizontal','Left','FontWeight','Bold','String','From:');        
...
uicontrol(CONVWIND,'Units','Normal','Style','Text',...
   'Position',[1/10  3/9 1.5/10 1/9],'Foreground',TITLEFOR,'Background',TITLEBAK,...
   'Horizontal','Left','FontWeight','Bold','String','To:');        
...
uicontrol(CONVWIND,'Units','Normal','Style','Text',...
   'Position',[  1/10 7/9 3.5/10 1/9],'Foreground',TITLEFOR,'Background',TITLEBAK,...
   'Horizontal','Left','FontWeight','Bold','String','Quantity Type:');        

type=uicontrol(CONVWIND,'Units','Normal','Style','Popup',...
   'Position',[4.0/10 7/9 5.0/10 1/9],'String', dimen,'FontWeight','Bold',...
   'CallBack',[...
